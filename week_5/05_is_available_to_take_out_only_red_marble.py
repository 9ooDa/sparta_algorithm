...
def move_until_wall_or_hole(r, c, diff_r, diff_c, g_map):
    move_count = 0
    while g_map[r + diff_r][c + diff_c] != '#' and g_map[r][c] != 'O':
        r += diff_r
        c += diff_c
        move_count += 1
...
def is_available_to_take_out_only_red_marble(game_map):
    ...
    queue.append((red_row, red_col, blue_row, blue_col, 1))  # 1은 탐색하는 횟수 -> 10번 이내여야 True
